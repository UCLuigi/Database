...
public class TestOptimalQueryPlanJoins {
  ...
  public void testJoinWithSelect() throws DatabaseException, QueryPlanException {
    Database.Transaction transaction = this.database.beginTransaction();
    ...
    queryPlan.select("int", QueryPlan.PredicateOperator.EQUALS, new IntDataBox(50));
  ...
  @Test
  @Category(StudentTestP4.class)
  public void testJoinComplexSelect() throws DatabaseException, QueryPlanException {
    Database.Transaction transaction = this.database.beginTransaction();
    transaction.queryAs(this.defaulTableName, "t1");
    transaction.queryAs(this.defaulTableName, "t2");
    ...
    queryPlan.select("int", QueryPlan.PredicateOperator.LESS_THAN, new IntDataBox(60));
    queryPlan.select("int", QueryPlan.PredicateOperator.GREATER_THAN_EQUALS, new IntDataBox(40));
