...
public class BNLJOperator extends JoinOperator {
  ...
  public int estimateIOCost() throws QueryPlanException {
    ...
    int io;
    int r = BNLJOperator.this.getLeftSource().getStats().getNumPages();
    int s = BNLJOperator.this.getRightSource().getStats().getNumPages();
    io = (int) Math.ceil(((double) r / (double) (numBuffers - 2))) * s + r;
    return io;
  }
